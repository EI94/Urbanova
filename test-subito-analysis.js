// Test Analisi Subito.it - Trova selettori corretti
...
async function analyzeSubito() {
  ...
  try {
    ...
    // Cerca elementi che contengono "m²"
    console.log('\n🔍 Cerca elementi con "m²"...');
    ...
    const links = $('a[href*="/annunci/"], a[href*="/item/"], a[href*="/detail/"]');
