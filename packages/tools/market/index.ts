      ...
      try {
        ...
        return {
          ...
          report: {
            ...
            pdfUrl: (reportResult.report as any).pdfUrl,
            summary: {
              marketHealth: reportResult.report.summary.marketHealth,
              riskLevel: reportResult.report.summary.riskLevel,
              opportunitiesCount: reportResult.report.summary.opportunities?.length || 0,
              risksCount: (reportResult.report.summary as any).risks?.length || 0,
            },
          },
