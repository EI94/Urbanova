...
exports.landScraperTool = exports.landScraperActions = exports.landScraperManifest = void 0;
const realLandScrapingAgent_1 = require('../../../src/lib/realLandScrapingAgent');
const projectManagerService_1 = require('../../../src/lib/projectManagerService');
// Real Land Scraper Tool
exports.landScraperManifest = {
  id: 'land',
  name: 'Land Scraper',
  version: '1.0.0',
  icon: '🗺️',
...
const landScrapingAgent = new realLandScrapingAgent_1.RealLandScrapingAgent();
const projectManager = new projectManagerService_1.ProjectManagerService();
exports.landScraperTool = {
  manifest: exports.landScraperManifest,
  actions: exports.landScraperActions,
  async scan_by_link(ctx, args) {
