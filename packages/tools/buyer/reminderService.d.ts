import { AppointmentReminder, ReminderTemplate, ReminderChannel, ReminderStatus } from '@urbanova/types';
/**
 * Reminder Service
 *
...
export declare class ReminderService {
     ...
     * Invia reminder
     */
    sendReminder(reminderId: string, channels?: ReminderChannel[]): Promise<{
        reminderId: string;
        results: {
            channel: ReminderChannel;
            sent: boolean;
