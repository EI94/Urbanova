import { Buyer, BuyerPreferences, RetentionPolicy, DataSubjectRights } from '@urbanova/types';
...
export declare class PrivacyService {
     ...
     */
    createBuyer(projectId: string, data?: {
        name?: string;
        email?: string;
        phone?: string;
     ...
     * Aggiorna buyer
     */
    updateBuyer(buyerId: string, updates: {
        name?: string;
        email?: string;
        phone?: string;
        preferences?: BuyerPreferences;
     ...
     */
    updatePrivacySettings(buyerId: string, retentionPolicy?: Partial<RetentionPolicy>, dataSubjectRights?: Partial<DataSubjectRights>): Promise<PrivacySettings>;
    /**
