import { AppointmentLocation, AppointmentParticipant, CollectKYCResponse, ScheduleFittingsResponse, RemindPaymentResponse, GetBuyerInfoResponse, ListAppointmentsResponse, GenerateICSResponse, SendReminderResponse, UpdatePrivacyResponse } from '@urbanova/types';
/**
...
export declare class BuyerTool {
     ...
     */
    collectKYC(projectId: string, buyerId?: string, documentTypes?: string[], options?: {
        sendEmail?: boolean;
     ...
     */
    scheduleFittings(buyerId: string, when: Date, location: AppointmentLocation, type: 'fitting' | 'visit' | 'consultation', participants?: AppointmentParticipant[], reminders?: {
        whatsapp?: boolean;
        email?: boolean;
        sms?: boolean;
    }, options?: {
     ...
     */
    remindPayment(buyerId: string, milestone: string, amount: number, dueDate: Date, options?: {
        sendWhatsApp?: boolean;
        sendEmail?: boolean;
        sendSMS?: boolean;
     ...
     */
    listAppointments(buyerId: string, status?: 'scheduled' | 'confirmed' | 'completed' | 'cancelled', fromDate?: Date, toDate?: Date): Promise<ListAppointmentsResponse>;
    /**
     * Generate ICS - Genera file ICS per appuntamento
     */
    generateICS(appointmentId: string, options?: {
     ...
     */
    sendReminder(reminderId: string, channels?: ('whatsapp' | 'email' | 'sms')[]): Promise<SendReminderResponse>;
    /**
     * Update Privacy - Aggiorna impostazioni privacy
     */
    updatePrivacy(buyerId: string, retentionPolicy?: {
