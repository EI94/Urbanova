...
class AppointmentService {
    ...
    async createAppointment(request) {
        ...
        console.log(`📅 Appointment Created - ID: ${appointment.id}, Type: ${request.type}, When: ${request.when.toISOString()}`);
        return appointment;
    }
    /**
    ...
    async updateAppointment(appointmentId, updates) {
        ...
        // Aggiorna campi
        if (updates.when)
            appointment.startTime = updates.when;
        if (updates.location)
    ...
    async cancelAppointment(appointmentId, reason) {
        ...
        appointment.updatedAt = new Date();
        // Metadata handling removed - not part of Appointment type
        console.log(`❌ Appointment Cancelled - ID: ${appointmentId}, Reason: ${reason || 'No reason provided'}`);
        return appointment;
    }
    /**
    ...
    async removeParticipant(appointmentId, participantEmail) {
        ...
        console.log(`👤 Participant Removed - Appointment: ${appointmentId}, Email: ${participantEmail}`);
        return appointment;
    }
    /**
     * Aggiungi reminder
