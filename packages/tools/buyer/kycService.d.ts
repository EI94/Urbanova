import { BuyerDocument } from '@urbanova/types';
...
export declare class KYCService {
     ...
     * Ottieni status KYC
     */
    getKYCStatus(buyerId: string): Promise<any>;
    /**
     * Lista richieste KYC
     */
     ...
     * Aggiorna status KYC
     */
    updateKYCStatus(kycRequestId: string, status: 'pending' | 'in_progress' | 'completed' | 'rejected'): Promise<KYCRequest>;
    /**
     * Elimina documento
     */
