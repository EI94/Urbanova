...
export class PrivacyService {
   ...
   */
  async getPrivacySettings(buyerId: string): Promise<PrivacySettings | null> {
   ...
   */
  async exportBuyerData(buyerId: string): Promise<{
    buyer: Buyer;
   ...
   */
  async checkRetentionPolicy(buyerId: string): Promise<{
   ...
   * Ottieni audit log
   */
  async getAuditLog(buyerId?: string, fromDate?: Date, toDate?: Date): Promise<any[]> {
