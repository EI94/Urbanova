...
exports.zUpdatePrivacyResponse = exports.zSendReminderResponse = exports.zGenerateICSResponse = exports.zListAppointmentsResponse = exports.zGetBuyerInfoResponse = exports.zRemindPaymentResponse = exports.zRemindPaymentRequest = exports.zScheduleFittingsResponse = exports.zScheduleFittingsRequest = exports.zCollectKYCResponse = exports.zCollectKYCRequest = exports.zGoogleOrganizer = exports.zGoogleAttendee = exports.zGoogleEvent = exports.zGoogleAuthResult = exports.zGoogleCalendarConfig = exports.zReminderTemplate = exports.zAppointmentReminder = exports.zICSRecurrence = exports.zICSAttachment = exports.zICSOrganizer = exports.zICSAttendee = exports.zICSEvent = exports.zICSFile = exports.zAppointmentAttachment = exports.zAppointmentParticipant = exports.zAppointmentLocation = exports.zAppointment = exports.zBuyerJWTLink = exports.zDataSubjectRights = exports.zRetentionPolicy = exports.zBuyerDocument = exports.zBuyerPreferences = exports.zBuyer = void 0;
...
exports.zBuyerJWTLink = zod_1.z.object({
    ...
    type: zod_1.z.enum(['upload', 'appointment', 'payment', 'access']).optional(),
    ...
    permissions: zod_1.z.array(zod_1.z.enum(['upload', 'download', 'view', 'edit', 'delete'])).optional(),
...
exports.zAppointment = zod_1.z.object({
    ...
    reminders: zod_1.z.array(zod_1.z.object({
        ...
        status: zod_1.z.enum(['pending', 'sent', 'delivered', 'failed', 'cancelled']),
...
exports.zReminderTemplate = zod_1.z.object({
    ...
    type: zod_1.z.enum(['whatsapp', 'email', 'sms']),
    channels: zod_1.z.array(zod_1.z.enum(['email', 'whatsapp', 'sms'])).optional(),
...
exports.zGoogleEvent = zod_1.z.object({
    ...
    transparency: zod_1.z.string().optional(),
    visibility: zod_1.z.string().optional(),
    reminders: zod_1.z.any().optional(),
});
exports.zGoogleAttendee = zod_1.z.object({
    email: zod_1.z.string(),
    displayName: zod_1.z.string(),
    responseStatus: zod_1.z.string(),
    organizer: zod_1.z.boolean().optional(),
});
...
exports.zCollectKYCResponse = zod_1.z.object({
    ...
    expiresAt: zod_1.z.date(),
    kycRequestId: zod_1.z.string().optional(),
    uploadLink: zod_1.z.string().optional(),
...
exports.zScheduleFittingsResponse = zod_1.z.object({
    success: zod_1.z.boolean(),
    appointment: exports.zAppointment.optional(),
    icsFile: exports.zICSFile.optional(),
    googleEvent: exports.zGoogleEvent.optional(),
    confirmationSent: zod_1.z.boolean().optional(),
    error: zod_1.z.string().optional(),
    message: zod_1.z.string().optional(),
});
...
exports.zRemindPaymentResponse = zod_1.z.object({
    ...
    sentChannels: zod_1.z.array(zod_1.z.string()).optional(),
    confirmationRequired: zod_1.z.boolean().optional(),
    confirmationReceived: zod_1.z.boolean().optional(),
    notifications: zod_1.z.array(zod_1.z.object({
        channel: zod_1.z.string(),
        sent: zod_1.z.boolean(),
...
exports.zGetBuyerInfoResponse = zod_1.z.object({
    success: zod_1.z.boolean(),
    buyer: exports.zBuyer.optional(),
    kycStatus: zod_1.z.string().optional(),
    documents: zod_1.z.array(exports.zBuyerDocument).optional(),
    appointments: zod_1.z.array(exports.zAppointment).optional(),
    privacySettings: zod_1.z.any().optional(),
    error: zod_1.z.string().optional(),
    message: zod_1.z.string().optional(),
});
exports.zListAppointmentsResponse = zod_1.z.object({
    success: zod_1.z.boolean(),
    appointments: zod_1.z.array(exports.zAppointment).optional(),
...
exports.zGenerateICSResponse = zod_1.z.object({
    success: zod_1.z.boolean(),
    icsFile: exports.zICSFile.optional(),
    downloadUrl: zod_1.z.string().optional(),
    expiresAt: zod_1.z.date().optional(),
...
exports.zSendReminderResponse = zod_1.z.object({
    success: zod_1.z.boolean(),
    reminderId: zod_1.z.string().optional(),
    sentChannels: zod_1.z.array(zod_1.z.string()).optional(),
    status: zod_1.z.string().optional(),
...
exports.zUpdatePrivacyResponse = zod_1.z.object({
    success: zod_1.z.boolean(),
    buyerId: zod_1.z.string().optional(),
    privacySettings: zod_1.z.object({
        consentGiven: zod_1.z.boolean(),
        consentDate: zod_1.z.date(),
        retentionPolicy: exports.zRetentionPolicy,
        dataSubjectRights: exports.zDataSubjectRights,
    }).optional(),
    message: zod_1.z.string().optional(),
    error: zod_1.z.string().optional(),
});
