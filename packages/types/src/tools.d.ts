...
export type ToolCategory = 'feasibility' | 'scraping' | 'analysis' | 'integration' | 'automation' | 'reporting' | 'other';
export declare const zToolManifest: z.ZodObject<{
    id: z.ZodString;
    name: z.ZodString;
    version: z.ZodString;
    icon: z.ZodOptional<z.ZodString>;
    category: z.ZodEnum<["feasibility", "scraping", "analysis", "integration", "automation", "reporting", "other"]>;
    ...
    id: string;
    description: string;
    category: "other" | "feasibility" | "scraping" | "analysis" | "integration" | "automation" | "reporting";
    name: string;
    version: string;
...
export type ToolRunStatus = 'pending' | 'running' | 'completed' | 'succeeded' | 'failed' | 'cancelled' | 'timeout';
...
export declare const zToolRun: z.ZodObject<{
    ...
    workspaceId: z.ZodString;
    userId: z.ZodString;
    status: z.ZodEnum<["pending", "running", "completed", "succeeded", "failed", "cancelled", "timeout"]>;
    startedAt: z.ZodDate;
    finishedAt: z.ZodOptional<z.ZodDate>;
    args: z.ZodRecord<z.ZodString, z.ZodUnknown>;
    ...
    subRuns: z.ZodOptional<z.ZodArray<z.ZodObject<{
        stepId: z.ZodString;
        status: z.ZodEnum<["pending", "running", "succeeded", "failed", "cancelled"]>;
        startedAt: z.ZodDate;
        finishedAt: z.ZodOptional<z.ZodDate>;
...
export declare const zTool: z.ZodObject<{
    ...
    uiExtensions: z.ZodOptional<z.ZodArray<z.ZodObject<{
