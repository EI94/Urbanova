...
export type ToolAction = 'ocr.process' | 'feasibility.run_bp' | 'land-scraper.scan_market' | 'doc-hunter.request' | 'messaging.send_wa' | 'market-intelligence.scan_city' | 'market-intelligence.trend_report' | 'deal-caller.send_questionnaire';
export type UsageMetric = 'ocr_pages' | 'feasibility_runs' | 'scraper_scans' | 'doc_requests' | 'wa_messages' | 'market_scans' | 'trend_reports' | 'questionnaires';
...
export declare const zEntitlement: z.ZodObject<{
    ...
    actionsLimits: z.ZodRecord<z.ZodString, z.ZodObject<{
        soft: z.ZodNumber;
        hard: z.ZodNumber;
    }, "strip", z.ZodTypeAny, {
        hard: number;
...
export declare const zEntitlementCheck: z.ZodObject<{
    ...
    reason: z.ZodOptional<z.ZodEnum<["hard_limit", "soft_limit", "trial_expired", "subscription_canceled"]>>;
