...
exports.METRIC_COSTS =
  ...
  exports.zUsageReport =
  exports.zEntitlementCheck =
  exports.zBillingState =
  exports.zUsageEvent =
  exports.zEntitlement =
  exports.zActionLimit =
    void 0;
...
exports.zEntitlementCheck = zod_1.z.object({
  ...
  reason: zod_1.z
    .enum(['hard_limit', 'soft_limit', 'trial_expired', 'subscription_canceled'])
    .optional(),
