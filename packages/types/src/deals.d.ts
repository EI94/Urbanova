...
declare const zZoningHint: z.ZodEnum<["residential", "commercial", "mixed", "industrial", "agricultural"]>;
declare const zDealNormalized: z.ZodObject<{
    ...
    zoningHint: z.ZodOptional<z.ZodEnum<["residential", "commercial", "mixed", "industrial", "agricultural"]>>;
...
declare const zSearchFilter: z.ZodObject<{
    ...
    zoning: z.ZodOptional<z.ZodArray<z.ZodEnum<["residential", "commercial", "mixed", "industrial", "agricultural"]>, "many">>;
...
export type { DealNormalized, SearchFilter, Watchlist, DealAlert, DealSearchResult, DealFingerprint, TrustFactors, };
