...
export declare const AVAILABLE_DOCUMENTS_OPTIONS: readonly ["planimetrie", "relazioni_tecniche", "certificazioni_energetiche", "perizie_tecniche", "visure_catastali", "certificati_agibilita", "documenti_urbanistici", "contratti_locazione", "altri_documenti"];
export declare const URBAN_CONSTRAINTS_OPTIONS: readonly ["vincoli_paesaggistici", "vincoli_archeologici", "vincoli_idrogeologici", "vincoli_acustici", "vincoli_ambientali", "vincoli_viabilita", "nessun_vincolo"];
export declare const EASEMENTS_OPTIONS: readonly ["passaggio_servitu", "elettrodotto", "gasdotto", "acquedotto", "fognatura", "telecomunicazioni", "nessuna_servitu"];
export declare const ACCESS_LIMITATIONS_OPTIONS: readonly ["strada_privata", "accesso_limitato", "orari_accesso", "restrizioni_veicolari", "nessuna_limitazione"];
