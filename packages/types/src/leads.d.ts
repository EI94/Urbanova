...
export declare const LeadSourceSchema: z.ZodEnum<
  ['immobiliare', 'idealista', 'casa', 'email', 'whatsapp', 'portal', 'unknown']
>;
...
export declare const LeadStatusSchema: z.ZodEnum<
  ['new', 'contacted', 'qualified', 'lost', 'won', 'archived']
>;
 ...
 */
export declare const ConversationChannelSchema: z.ZodEnum<
  ['email', 'whatsapp', 'portal:immobiliare', 'portal:idealista', 'portal:casa', 'portal:generic']
>;
...
export declare const SLATrackerSchema: z.ZodObject<
  {
    ...
    escalationHistory: z.ZodDefault<
      z.ZodArray<
        z.ZodObject<
          {
            level: z.ZodNumber;
    ...
    conditions: z.ZodObject<
      {
        ...
        leadPriority: z.ZodOptional<
          z.ZodArray<z.ZodEnum<['low', 'medium', 'high', 'urgent']>, 'many'>
        >;
      },
      'strip',
      z.ZodTypeAny,
      {
        leadSource?:
          | ('unknown' | 'email' | 'whatsapp' | 'immobiliare' | 'idealista' | 'casa' | 'portal')[]
          | undefined;
