 ...
 */
import { z } from 'zod';
export type RuleCategory = 'DISTACCHI' | 'ALTEZZE' | 'PARCHEGGI' | 'SUPERFICI' | 'VOLUMI' | 'ACCESSIBILITA' | 'AMBIENTALE' | 'STORICO' | 'ALTRO';
export type ComplianceStatusType = 'COMPLIANT' | 'NON_COMPLIANT' | 'PARTIALLY_COMPLIANT' | 'REQUIRES_REVIEW' | 'NOT_APPLICABLE';
export type ComplianceDocumentType = 'REGOLAMENTO_URBANISTICO' | 'PIANO_REGOLATORE' | 'NORME_TECNICHE' | 'VARIANTE' | 'DELIBERA' | 'ALTRO';
...
declare const zComplianceDocument: z.ZodObject<{
    ...
    type: z.ZodEnum<["REGOLAMENTO_URBANISTICO", "PIANO_REGOLATORE", "NORME_TECNICHE", "VARIANTE", "DELIBERA", "ALTRO"]>;
    title: z.ZodString;
...
declare const zPatternRule: z.ZodObject<{
    id: z.ZodString;
    municipalityId: z.ZodString;
    category: z.ZodEnum<["DISTACCHI", "ALTEZZE", "PARCHEGGI", "SUPERFICI", "VOLUMI", "ACCESSIBILITA", "AMBIENTALE", "STORICO", "ALTRO"]>;
    name: z.ZodString;
    description: z.ZodString;
    ...
    id: string;
    description: string;
    category: "DISTACCHI" | "ALTEZZE" | "PARCHEGGI" | "SUPERFICI" | "VOLUMI" | "ACCESSIBILITA" | "AMBIENTALE" | "STORICO" | "ALTRO";
...
declare const zComplianceCheck: z.ZodObject<{
    ...
    municipalityId: z.ZodString;
    ruleId: z.ZodString;
    status: z.ZodEnum<["COMPLIANT", "NON_COMPLIANT", "PARTIALLY_COMPLIANT", "REQUIRES_REVIEW", "NOT_APPLICABLE"]>;
    actualValue: z.ZodAny;
    expectedValue: z.ZodAny;
    deviation: z.ZodNumber;
    citations: z.ZodArray<z.ZodObject<{
...
declare const zComplianceReport: z.ZodObject<{
    ...
    projectId: z.ZodString;
    municipalityId: z.ZodString;
    overallStatus: z.ZodEnum<["COMPLIANT", "NON_COMPLIANT", "PARTIALLY_COMPLIANT", "REQUIRES_REVIEW", "NOT_APPLICABLE"]>;
...
declare const zComplianceCheckRequest: z.ZodObject<{
    ...
    ruleCategories: z.ZodOptional<z.ZodArray<z.ZodEnum<["DISTACCHI", "ALTEZZE", "PARCHEGGI", "SUPERFICI", "VOLUMI", "ACCESSIBILITA", "AMBIENTALE", "STORICO", "ALTRO"]>, "many">>;
    includeCitations: z.ZodOptional<z.ZodBoolean>;
    includeRecommendations: z.ZodOptional<z.ZodBoolean>;
}, "strip", z.ZodTypeAny, {
    projectId: string;
    municipalityId?: string | undefined;
    ruleCategories?: ("DISTACCHI" | "ALTEZZE" | "PARCHEGGI" | "SUPERFICI" | "VOLUMI" | "ACCESSIBILITA" | "AMBIENTALE" | "STORICO" | "ALTRO")[] | undefined;
...
declare const zComplianceSearchRequest: z.ZodObject<{
    municipalityId: z.ZodString;
    query: z.ZodString;
    categories: z.ZodOptional<z.ZodArray<z.ZodEnum<["DISTACCHI", "ALTEZZE", "PARCHEGGI", "SUPERFICI", "VOLUMI", "ACCESSIBILITA", "AMBIENTALE", "STORICO", "ALTRO"]>, "many">>;
    documentTypes: z.ZodOptional<z.ZodArray<z.ZodEnum<["REGOLAMENTO_URBANISTICO", "PIANO_REGOLATORE", "NORME_TECNICHE", "VARIANTE", "DELIBERA", "ALTRO"]>, "many">>;
    limit: z.ZodOptional<z.ZodNumber>;
    threshold: z.ZodOptional<z.ZodNumber>;
}, "strip", z.ZodTypeAny, {
    municipalityId: string;
    query: string;
    categories?: ("DISTACCHI" | "ALTEZZE" | "PARCHEGGI" | "SUPERFICI" | "VOLUMI" | "ACCESSIBILITA" | "AMBIENTALE" | "STORICO" | "ALTRO")[] | undefined;
    documentTypes?: ("ALTRO" | "REGOLAMENTO_URBANISTICO" | "PIANO_REGOLATORE" | "NORME_TECNICHE" | "VARIANTE" | "DELIBERA")[] | undefined;
...
export { zMunicipality, zComplianceDocument, zDocumentSection, zCitation, zPatternRule, zRuleParameter, zRuleValidation, zComplianceViolation, zComplianceCheck, zComplianceReport, zComplianceIngestRequest, zComplianceCheckRequest, zComplianceSearchRequest, };
