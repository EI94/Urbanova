...
export async function GET(request: NextRequest) {
  try {
    console.log('🧪 TEST ROBUST EMAIL SERVICE - Verifica tutti i servizi...');
    ...
    console.error('❌ Errore test robust email service:', error);
    return NextResponse.json(
      { 
        success: false,
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🧪 TEST INVIO EMAIL REALE - Dati ricevuti:', { to, subject });
    ...
    console.log('🔄 Test invio email reale con servizio robusto...');
