...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🗺️ [API Map] Creazione cluster per zoom:', zoom, 'e', locations.length, 'posizioni');
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🗺️ [API Map] Creazione cluster per zoom:', zoomLevel, 'e', locations.length, 'posizioni');
