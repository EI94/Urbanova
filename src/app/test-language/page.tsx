...
function TestLanguagePageContent() {
  ...
  const runLanguageTests = async () => {
    ...
    try {
      ...
      const navTests = ['dashboard', 'landScraping', 'feasibilityAnalysis', 'businessPlan'];
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">🌍 Test Sistema Multilingua</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-2 text-sm">
              <p>
                <strong>Formato data:</strong> {languageConfig.dateFormat}
              </p>
              <p>
                <strong>Valuta:</strong> {languageConfig.numberFormat.currency}
              </p>
              <p>
                <strong>Direzione:</strong> {isRTL ? 'RTL' : 'LTR'}
              </p>
              <p>
                <strong>Decimali:</strong> {languageConfig.numberFormat.decimal}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong>Dashboard:</strong> {t('dashboard', 'common')}
                </div>
                <div>
                  <strong>Progetti:</strong> {t('projects', 'common')}
                </div>
                <div>
                  <strong>Impostazioni:</strong> {t('settings', 'common')}
                </div>
                <div>
                  <strong>Cerca:</strong> {t('search', 'common')}
                </div>
                <div>
                  <strong>Caricamento:</strong> {t('loading', 'common')}
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong>Dashboard:</strong> {t('dashboard', 'navigation')}
                </div>
                <div>
                  <strong>AI Land Scraping:</strong> {t('landScraping', 'navigation')}
                </div>
                <div>
                  <strong>Analisi Fattibilità:</strong> {t('feasibilityAnalysis', 'navigation')}
                </div>
                <div>
                  <strong>Business Plan:</strong> {t('businessPlan', 'navigation')}
                </div>
                <div>
                  <strong>Marketing:</strong> {t('marketing', 'navigation')}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong>Oggi:</strong> {formatDate(new Date())}
                </div>
                <div>
                  <strong>Ieri:</strong> {formatDate(new Date(Date.now() - 86400000))}
                </div>
                <div>
                  <strong>Tra una settimana:</strong>{' '}
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong>1,234.56:</strong> {formatNumber(1234.56)}
                </div>
                <div>
                  <strong>1,000,000:</strong> {formatNumber(1000000)}
                </div>
                <div>
                  <strong>0.123:</strong> {formatNumber(0.123)}
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong>€1,500:</strong> {formatCurrency(1500)}
                </div>
                <div>
                  <strong>€1,000,000:</strong> {formatCurrency(1000000)}
                </div>
                <div>
                  <strong>€50.99:</strong> {formatCurrency(50.99)}
                </div>
              </div>
            </div>
          </div>
