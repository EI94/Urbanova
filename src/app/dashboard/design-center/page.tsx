            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Crea e gestisci i tuoi progetti di design</p>
        </div>
              </div>
            </div>
        ...
        <div className="w-64 bg-white border-r border-gray-200 min-h-screen">
          <div className="p-6">
            <nav className="space-y-2">
              ...
              <Link href="/dashboard/design-center" className="flex items-center space-x-3 px-3 py-2 text-blue-600 bg-blue-50 rounded-lg transition-colors">
