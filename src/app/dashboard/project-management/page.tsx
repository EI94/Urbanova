          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">📋 Gestione Progetti</h1>
                  <p className="text-sm text-gray-500">Gestisci documenti, riunioni e timeline dei tuoi progetti</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
