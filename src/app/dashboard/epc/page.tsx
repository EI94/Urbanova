  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">🏗️ EPC - Energy Performance Certificate</h1>
          <p className="text-gray-600 mt-1">Gestisci certificazioni energetiche e documentazione tecnica</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-gray-600 mb-4">Gestisci documentazione del cantiere e certificazioni</p>
