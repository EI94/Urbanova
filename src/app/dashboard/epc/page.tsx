          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">🏗️ EPC - Energy Performance Certificate</h1>
                  <p className="text-sm text-gray-500">Gestisci certificazioni energetiche e documentazione tecnica</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
