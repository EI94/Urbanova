          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">Business Plan Generator AI</h1>
                  <p className="text-sm text-gray-500">Genera piani d'affari professionali con proiezioni finanziarie intelligenti</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
