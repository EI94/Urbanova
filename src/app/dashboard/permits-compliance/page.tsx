    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="px-6 py-4">
          ...
          <div>
                  <h1 className="text-xl font-semibold text-gray-900">Permessi & Compliance</h1>
                  <p className="text-sm text-gray-600">Gestisci permessi e controlli di conformità</p>
                </div>
              </div>
            </div>
            <button className="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
              <Plus className="w-4 h-4" />
              <span>Nuovo Permesso</span>
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="w-64 bg-white border-r border-gray-200 min-h-screen">
          <div className="p-6">
            <nav className="space-y-2">
              ...
              <Link href="/dashboard/permits-compliance" className="flex items-center space-x-3 px-3 py-2 text-red-600 bg-red-50 rounded-lg transition-colors">
