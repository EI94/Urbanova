...
export default function KnowledgeManagement({
  ...
  const [activeTab, setActiveTab] = useState<
    'browse' | 'search' | 'create' | 'templates' | 'stats'
  >('browse');
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Base di conoscenza e documentazione centralizzata
              </p>
            </div>
          </div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        setSearchFilters(prev => ({
                          ...prev,
                          language: e.target.value as ContentLanguage | '',
                        }))
                      }
                      className="border border-gray-300 rounded-md px-3 py-1 text-sm focus:ring-blue-500 focus:border-blue-500"
                    >
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {getCategoryName(result.document.categoryId)} •{' '}
                              {result.document.authorName}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-2">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={e =>
                          setNewDocument(prev => ({ ...prev, categoryId: e.target.value }))
                        }
                        className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500"
                      >
                  ...
                  <div className="flex items-center justify-end space-x-3">
                    ...
                    <button
                      ...
                      disabled={
                        !newDocument.title || !newDocument.content || !newDocument.categoryId
                      }
                ...
                {templates.map(template => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <Badge
                        className={`${getTypeIcon(template.type)} bg-purple-100 text-purple-800`}
                      >
                        {template.type}
                      </Badge>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-medium text-gray-900">
                          {stats.qualityMetrics.averageFreshnessScore}/100
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-700">Completezza</span>
                        <span className="text-sm font-medium text-gray-900">
                          {stats.qualityMetrics.averageCompletenessScore}/100
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-700">Accuratezza</span>
                        <span className="text-sm font-medium text-gray-900">
                          {stats.qualityMetrics.averageAccuracyScore}/100
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-700">Utilità</span>
                        <span className="text-sm font-medium text-gray-900">
                          {stats.qualityMetrics.averageUsefulnessScore}/100
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-end space-x-3 mt-6">
                ...
                <button
                  ...
                  disabled={selectedTemplate.placeholders.some(
                    p => p.required && !templateValues[p.key]
                  )}
                  className="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-md transition-colors"
                >
                  Crea da Template
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {getCategoryName(selectedDocument.categoryId)} • {selectedDocument.authorName}
                    </p>
                  </div>
                </div>
                <button
                ...
                <div className="prose prose-sm max-w-none">
                  <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                    <p className="text-sm text-gray-600 mb-2">
                      <strong>Descrizione:</strong> {selectedDocument.description}
                    </p>
