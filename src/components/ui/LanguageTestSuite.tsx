...
export default function LanguageTestSuite({ autoRun = false, onComplete }: LanguageTestSuiteProps) {
        ...
        <div className="space-y-3 max-h-96 overflow-y-auto">
          {results.map((result, index) => (
            ...
            >
              ...
              <div className="text-xs text-gray-500 ml-4">{result.duration}ms</div>
            </div>
          ))}
        </div>
      )}
