...
export class AdvancedLocationsService {
    ...
    try {
      ...
      const provinces = [
        ...
        { id: 'mo', name: 'Modena', region: 'Emilia-Romagna', searchTerms: ['modena', 'modenese'] },
        {
          ...
          region: 'Calabria',
          searchTerms: ['reggio calabria', 'reggino'],
        },
        {
          id: 're',
          name: 'Reggio Emilia',
          region: 'Emilia-Romagna',
          searchTerms: ['reggio emilia', 'reggiano'],
        },
        ...
        { id: 'li', name: 'Livorno', region: 'Toscana', searchTerms: ['livorno', 'livornese'] },
        {
          ...
          name: 'Ravenna',
          region: 'Emilia-Romagna',
          searchTerms: ['ravenna', 'ravennate'],
        },
        {
          id: 'ca',
          name: 'Cagliari',
          region: 'Sardegna',
          searchTerms: ['cagliari', 'cagliaritano'],
        },
        ...
        { id: 'bg', name: 'Bergamo', region: 'Lombardia', searchTerms: ['bergamo', 'bergamasco'] },
        {
          ...
          name: 'Forlì-Cesena',
          region: 'Emilia-Romagna',
          searchTerms: ['forlì', 'cesena', 'forlivese', 'cesenate'],
        },
        { id: 'vi', name: 'Vicenza', region: 'Veneto', searchTerms: ['vicenza', 'vicentino'] },
        {
          ...
          searchTerms: ['trento', 'trentino'],
        },
        {
          id: 'bz',
          name: 'Bolzano',
          region: 'Trentino-Alto Adige',
          searchTerms: ['bolzano', 'bolzanino'],
        },
        { id: 'no', name: 'Novara', region: 'Piemonte', searchTerms: ['novara', 'novarese'] },
        {
          ...
          name: 'Piacenza',
          region: 'Emilia-Romagna',
          searchTerms: ['piacenza', 'piacentino'],
        },
        {
          id: 'ud',
          name: 'Udine',
          region: 'Friuli-Venezia Giulia',
          searchTerms: ['udine', 'udinese'],
        },
        { id: 'an', name: 'Ancona', region: 'Marche', searchTerms: ['ancona', 'anconetano'] },
        {
          ...
          region: 'Puglia',
          searchTerms: ['barletta', 'andria', 'trani'],
        },
        ...
        { id: 'le', name: 'Lecce', region: 'Puglia', searchTerms: ['lecce', 'leccese'] },
        {
          ...
          region: 'Marche',
          searchTerms: ['pesaro', 'urbino', 'pesarese', 'urbinate'],
        },
        {
          id: 'al',
          name: 'Alessandria',
          region: 'Piemonte',
          searchTerms: ['alessandria', 'alessandrino'],
        },
        ...
        { id: 'mn', name: 'Mantova', region: 'Lombardia', searchTerms: ['mantova', 'mantovano'] },
        {
          ...
          name: 'Massa-Carrara',
          region: 'Toscana',
          searchTerms: ['massa', 'carrara', 'massese', 'carrarino'],
        },
        {
          id: 'mb',
          name: 'Monza e Brianza',
          region: 'Lombardia',
          searchTerms: ['monza', 'brianza', 'monzese', 'brianzolo'],
        },
      ...
      const majorComunes = [
        // Lazio - Roma e dintorni
        {
          ...
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['roma', 'capitale', 'eterna', 'lazio'],
        },
        {
          id: 'frascati',
          name: 'Frascati',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['frascati', 'frascatano', 'castelli romani'],
        },
        {
          id: 'castel-gandolfo',
          ...
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['castel gandolfo', 'castelli romani'],
        },
        {
          id: 'albano-laziale',
          name: 'Albano Laziale',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['albano laziale', 'castelli romani'],
        },
        {
          id: 'aricia',
          name: 'Ariccia',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['aricia', 'castelli romani'],
        },
        {
          id: 'marino',
          name: 'Marino',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['marino', 'castelli romani'],
        },
        {
          id: 'velletri',
          name: 'Velletri',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['velletri', 'velletrano'],
        },
        {
          id: 'ciampino',
          name: 'Ciampino',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['ciampino', 'aeroporto'],
        },
        {
          id: 'fiumicino',
          name: 'Fiumicino',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['fiumicino', 'aeroporto', 'mare'],
        },
        {
          id: 'ostia',
          name: 'Ostia',
        ...
        },
        {
          ...
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['tivoli', 'villa adriana', "villa d'este"],
        },
        {
          ...
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['guidonia', 'montecelio'],
        },
        {
          id: 'pomezia',
          name: 'Pomezia',
        ...
        },
        {
          ...
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['nettuno', 'mare', 'santa maria'],
        },
        {
          id: 'cerveteri',
          name: 'Cerveteri',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['cerveteri', 'etruschi', 'necropoli'],
        },
        {
          id: 'ladispoli',
          name: 'Ladispoli',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['ladispoli', 'mare', 'castello'],
        },
        {
          id: 'bracciano',
          name: 'Bracciano',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['bracciano', 'lago', 'castello orsini'],
        },
        {
          id: 'angullara-sabazia',
          name: 'Anguillara Sabazia',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['anguillara', 'sabazia', 'lago'],
        },
        {
          id: 'trevignano-romano',
          name: 'Trevignano Romano',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['trevignano', 'lago', 'romano'],
        },
        ...
        // Quartieri di Roma
        {
          ...
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['garbatella', 'roma', 'quartiere', 'ostiense'],
        },
        {
          id: 'testaccio',
          name: 'Testaccio',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['testaccio', 'roma', 'quartiere', 'aventino'],
        },
        {
          id: 'trastevere',
          name: 'Trastevere',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['trastevere', 'roma', 'quartiere', 'tiber'],
        },
        {
          id: 'monti',
          name: 'Monti',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['monti', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'campo-marzio',
          name: 'Campo Marzio',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['campo marzio', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'parione',
          name: 'Parione',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['parione', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'regola',
          name: 'Regola',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['regola', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'sant-angelo',
          name: "Sant'Angelo",
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['sant angelo', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'pigna',
          name: 'Pigna',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['pigna', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'campitelli',
          name: 'Campitelli',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['campitelli', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'sant-eustachio',
          name: "Sant'Eustachio",
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['sant eustachio', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'colonna',
          name: 'Colonna',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colonna', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'ludovisi',
          name: 'Ludovisi',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['ludovisi', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'sallustiano',
          name: 'Sallustiano',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['sallustiano', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'castro-pretorio',
          ...
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['castro pretorio', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'esquilino',
          name: 'Esquilino',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['esquilino', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'celio',
          name: 'Celio',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['celio', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'oppio',
          name: 'Oppio',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['oppio', 'roma', 'quartiere', 'centro'],
        },
        {
          id: 'appio-latino',
          name: 'Appio Latino',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['appio latino', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'appio-pignatelli',
          name: 'Appio Pignatelli',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['appio pignatelli', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'tuscolano',
          name: 'Tuscolano',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['tuscolano', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'don-bosco',
          name: 'Don Bosco',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['don bosco', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'appio-claudio',
          name: 'Appio Claudio',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['appio claudio', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'cincinnato',
          name: 'Cincinnato',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['cincinnato', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'quadraro',
          name: 'Quadraro',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['quadraro', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'tuscolano-nord',
          name: 'Tuscolano Nord',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['tuscolano nord', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'tuscolano-sud',
          name: 'Tuscolano Sud',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['tuscolano sud', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'eur',
          name: 'EUR',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['eur', 'roma', 'quartiere', 'sud', 'esposizione universale'],
        },
        {
          id: 'ostiense',
          name: 'Ostiense',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['ostiense', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'portuense',
          name: 'Portuense',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['portuense', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'gianicolense',
          name: 'Gianicolense',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['gianicolense', 'roma', 'quartiere', 'ovest'],
        },
        {
          id: 'aurelio',
          name: 'Aurelio',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['aurelio', 'roma', 'quartiere', 'ovest'],
        },
        {
          id: 'trionfale',
          name: 'Trionfale',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['trionfale', 'roma', 'quartiere', 'ovest'],
        },
        {
          id: 'della-vittoria',
          name: 'Della Vittoria',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['della vittoria', 'roma', 'quartiere', 'ovest'],
        },
        {
          id: 'monte-mario',
          name: 'Monte Mario',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['monte mario', 'roma', 'quartiere', 'ovest'],
        },
        {
          id: 'della-vittoria-nord',
          name: 'Della Vittoria Nord',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['della vittoria nord', 'roma', 'quartiere', 'ovest'],
        },
        {
          id: 'della-vittoria-sud',
          name: 'Della Vittoria Sud',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['della vittoria sud', 'roma', 'quartiere', 'ovest'],
        },
        {
          id: 'flaminio',
          name: 'Flaminio',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['flaminio', 'roma', 'quartiere', 'nord'],
        },
        {
          id: 'salario',
          name: 'Salario',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['salario', 'roma', 'quartiere', 'nord'],
        },
        {
          id: 'nomentano',
          name: 'Nomentano',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['nomentano', 'roma', 'quartiere', 'nord'],
        },
        {
          id: 'tiburtino',
          name: 'Tiburtino',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['tiburtino', 'roma', 'quartiere', 'nord'],
        },
        {
          id: 'colli-aniene',
          name: 'Colli Aniene',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli aniene', 'roma', 'quartiere', 'nord'],
        },
        {
          id: 'colli-portuensi',
          name: 'Colli Portuensi',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli portuensi', 'roma', 'quartiere', 'nord'],
        },
        {
          id: 'colli-albani',
          name: 'Colli Albani',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli albani', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'colli-lanuvini',
          name: 'Colli Lanuvini',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli lanuvini', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'colli-velini',
          name: 'Colli Velini',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli velini', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'colli-cimini',
          name: 'Colli Cimini',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli cimini', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'colli-sabini',
          name: 'Colli Sabini',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli sabini', 'roma', 'quartiere', 'nord'],
        },
        {
          id: 'colli-tiburtini',
          name: 'Colli Tiburtini',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli tiburtini', 'roma', 'quartiere', 'nord'],
        },
        {
          id: 'colli-romani',
          name: 'Colli Romani',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli romani', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'colli-laziali',
          name: 'Colli Laziali',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli laziali', 'roma', 'quartiere', 'sud'],
        },
        {
          id: 'colli-prenestini',
          name: 'Colli Prenestini',
          province: 'RM',
          region: 'Lazio',
          searchTerms: ['colli prenestini', 'roma', 'quartiere', 'est'],
        },
        {
          id: 'colli-albani',
          name: 'Colli Albani',
        ...
        // Lombardia
        {
          ...
          province: 'MI',
          region: 'Lombardia',
          searchTerms: ['milano', 'milanese', 'moda'],
        },
        {
          id: 'bergamo',
          name: 'Bergamo',
          province: 'BG',
          region: 'Lombardia',
          searchTerms: ['bergamo', 'bergamasco', 'alta'],
        },
        {
          id: 'brescia',
          name: 'Brescia',
          province: 'BS',
          region: 'Lombardia',
          searchTerms: ['brescia', 'bresciano', 'leonessa'],
        },
        {
          id: 'como',
          name: 'Como',
        ...
        },
        {
          ...
          province: 'CR',
          region: 'Lombardia',
          searchTerms: ['cremona', 'cremonese', 'violino'],
        },
        {
          id: 'lecco',
          name: 'Lecco',
          province: 'LC',
          region: 'Lombardia',
          searchTerms: ['lecco', 'lecchese', 'lago'],
        },
        {
          id: 'lodi',
          name: 'Lodi',
        ...
        },
        {
          ...
          province: 'MN',
          region: 'Lombardia',
          searchTerms: ['mantova', 'mantovano', 'gonzaga'],
        },
        {
          id: 'monza',
          name: 'Monza',
          province: 'MB',
          region: 'Lombardia',
          searchTerms: ['monza', 'monzese', 'brianza'],
        },
        {
          id: 'pavia',
          name: 'Pavia',
          province: 'PV',
          region: 'Lombardia',
          searchTerms: ['pavia', 'pavese', 'certosa'],
        },
        {
          id: 'sondrio',
          name: 'Sondrio',
          province: 'SO',
          region: 'Lombardia',
          searchTerms: ['sondrio', 'sondriese', 'valtellina'],
        },
        {
          id: 'varese',
          name: 'Varese',
          province: 'VA',
          region: 'Lombardia',
          searchTerms: ['varese', 'varesino', 'lago'],
        },
        ...
        // Toscana
        {
          ...
          province: 'FI',
          region: 'Toscana',
          searchTerms: ['firenze', 'fiorentino', 'rinascimento'],
        },
        {
          id: 'arezzo',
          name: 'Arezzo',
          province: 'AR',
          region: 'Toscana',
          searchTerms: ['arezzo', 'aretino', 'giostra'],
        },
        {
          id: 'grosseto',
          name: 'Grosseto',
          province: 'GR',
          region: 'Toscana',
          searchTerms: ['grosseto', 'grossetano', 'maremma'],
        },
        {
          id: 'livorno',
          name: 'Livorno',
          province: 'LI',
          region: 'Toscana',
          searchTerms: ['livorno', 'livornese', 'porto'],
        },
        {
          id: 'lucca',
          name: 'Lucca',
          province: 'LU',
          region: 'Toscana',
          searchTerms: ['lucca', 'lucchese', 'mura'],
        },
        {
          id: 'massa',
          name: 'Massa',
          province: 'MS',
          region: 'Toscana',
          searchTerms: ['massa', 'massese', 'carrara'],
        },
        {
          id: 'pisa',
          name: 'Pisa',
        ...
        },
        {
          ...
          province: 'PO',
          region: 'Toscana',
          searchTerms: ['prato', 'pratese', 'tessile'],
        },
        {
          id: 'siena',
          name: 'Siena',
          province: 'SI',
          region: 'Toscana',
          searchTerms: ['siena', 'senese', 'palio'],
        },
      ];
      ...
      const europeanCities = [
        {
          ...
          name: 'Parigi',
          country: 'FR',
          searchTerms: ['paris', 'parigi', 'france', 'francia'],
        },
        {
          id: 'london',
          name: 'Londra',
          country: 'GB',
          searchTerms: ['london', 'londra', 'england', 'inghilterra'],
        },
        {
          id: 'berlin',
          name: 'Berlino',
          country: 'DE',
          searchTerms: ['berlin', 'berlino', 'germany', 'germania'],
        },
        { id: 'madrid', name: 'Madrid', country: 'ES', searchTerms: ['madrid', 'spain', 'spagna'] },
        {
          ...
          name: 'Barcellona',
          country: 'ES',
          searchTerms: ['barcelona', 'barcellona', 'catalunya'],
        },
        {
          id: 'amsterdam',
          name: 'Amsterdam',
          country: 'NL',
          searchTerms: ['amsterdam', 'netherlands', 'paesi bassi'],
        },
        {
          id: 'brussels',
          name: 'Bruxelles',
          country: 'BE',
          searchTerms: ['brussels', 'bruxelles', 'belgium', 'belgio'],
        },
        { id: 'vienna', name: 'Vienna', country: 'AT', searchTerms: ['vienna', 'austria'] },
        {
          ...
          name: 'Zurigo',
          country: 'CH',
          searchTerms: ['zurich', 'zurigo', 'switzerland', 'svizzera'],
        },
        {
          id: 'geneva',
          name: 'Ginevra',
          country: 'CH',
          searchTerms: ['geneva', 'ginevra', 'switzerland', 'svizzera'],
        },
        {
          id: 'milan',
          name: 'Milano',
          country: 'IT',
          searchTerms: ['milan', 'milano', 'italy', 'italia'],
        },
        {
          id: 'rome',
          name: 'Roma',
          country: 'IT',
          searchTerms: ['rome', 'roma', 'italy', 'italia'],
        },
        {
          id: 'venice',
          name: 'Venezia',
          country: 'IT',
          searchTerms: ['venice', 'venezia', 'italy', 'italia'],
        },
        {
          id: 'florence',
          name: 'Firenze',
          country: 'IT',
          searchTerms: ['florence', 'firenze', 'italy', 'italia'],
        },
        {
          id: 'naples',
          name: 'Napoli',
          country: 'IT',
          searchTerms: ['naples', 'napoli', 'italy', 'italia'],
        },
      ];
  ...
  private loadFallbackLocations() {
    ...
    const fallbackLocations: AdvancedLocation[] = [
      ...
      },
      {
        ...
        type: 'comune',
        region: 'Lazio',
        searchTerms: ['frascati', 'frascatano'],
        country: 'IT',
      },
    ];
  ...
  async searchLocations(query: string, limit: number = 20): Promise<AdvancedLocation[]> {
    ...
    const searchTermMatches = this.locations.filter(location => {
      ...
      return searchTermsLower.some(
        term => term === queryLower || term.startsWith(queryLower) || term.includes(queryLower)
      );
    });
  ...
  async getLocationsByRegion(region: string): Promise<AdvancedLocation[]> {
    await this.initializeLocations();
    return this.locations.filter(loc => loc.region?.toLowerCase() === region.toLowerCase());
  }

  // Ottieni località per provincia
  async getLocationsByProvince(province: string): Promise<AdvancedLocation[]> {
    await this.initializeLocations();
    return this.locations.filter(loc => loc.province?.toLowerCase() === province.toLowerCase());
  }
